...
Updater tests use fake npm and CLI executables. Portability tests use isolated homes and export/import fixtures. Architecture Guardian runs both focused smoke and data-driven scenarios.
