...
5. Implement only inside the approved scope. The Claude PreToolUse hook can
...
Claude hook setup (PreToolUse scope enforcement):
...
#         "hooks": [{ "type": "command", "command": "agent-kernel-architecture-hook" }] }
#     ]
#   }
# }
```
